        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Aqua Alert</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Empowering communities to monitor and protect water safety through collaborative reporting and real-time hazard tracking.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@aquaalert.org</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-blue-400" />
                <span className="text-gray-300">1-800-AQUA-911</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-4 w-4 text-blue-400" />
                <span className="text-gray-300">Global Water Safety Initiative</span>
              </div>
            </div>
          </div>
        </div>
